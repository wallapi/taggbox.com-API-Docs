...
.github/copilot-instructions.md and the API spec is in llms.txt here - follow both exactly,
...
Do not ask me questions - use the defaults above and in .github/copilot-instructions.md. Create
