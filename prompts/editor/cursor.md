# Cursor - build a Taggbox social wall
...
printf -- '---\ndescription: Taggbox social wall rules\nalwaysApply: true\n---\n' > .cursor/rules/taggbox.mdc
...
"---`ndescription: Taggbox social wall rules`nalwaysApply: true`n---" | Set-Content .cursor/rules/taggbox.mdc
