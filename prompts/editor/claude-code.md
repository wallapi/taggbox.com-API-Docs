# Claude Code - build a Taggbox social wall
...
curl -sSLo CLAUDE.md https://raw.githubusercontent.com/wallapi/taggbox.com-API-Docs/main/prompts/TAGGBOX_CONTEXT.md
```
...
curl.exe -sSLo CLAUDE.md https://raw.githubusercontent.com/wallapi/taggbox.com-API-Docs/main/prompts/TAGGBOX_CONTEXT.md
```
...
```
Build the Taggbox social wall described in CLAUDE.md and llms.txt in this folder. Use PHP 8: one self-contained index.php, nothing to install.
...
```
Build the Taggbox social wall described in CLAUDE.md and llms.txt in this folder. Use Node.js 18+ with Express: server.js and package.json.
Don't ask me anything; create the files, then tell me how to run it as if I've never used a terminal.
```
